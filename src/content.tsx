...
export const defaultDaysData: Record<number, DayContent> = {
  ...
  13: {
  "title": "День 13",
  "description": "**17:30** Сообщение в транзите через астероидное поле. Будьте осторожны: кажется, за перехват этого файла назначена солидная награда. Отдыхайте с чатом, пока наемники не вышли на след.\n\n---\n\n**04:40** След потерян. Даже Детективное зрение не помогает найти смысл в продолжении этого пути. Мы зашли в тупик и сворачиваем расследование. Пусть эти 50 миллионов достанутся кому-то другому.",
  "todos": [
    {
      "id": 1,
  ...
  "streamLink": "https://www.twitch.tv/videos/2642815274",
  "hidden": false,
  "imageUrl": "https://i.ibb.co/Z7dMzdF/13.jpg",
  "forceOpen": true,
  "customColor": "#000000"
  ...
  14: {
  "title": "День 14",
  "description": "**19:30** Внимание экипажу! В биологическом отсеке пилота обнаружен критический сбой. Системы жизнеобеспечения требуют немедленного постельного режима. Активные миссии отменены. Переводим экраны в режим «Кинотеатр»: сегодня лечимся новогодними фильмами и горячим чаем. Не болейте!",
  "todos": [
    {
      "id": 1,
  ...
  18: {
  "title": "День 18",
  "description": "**15:00** Звездная карта затерялась где-то среди бесконечных серых плит и сугробов. Ждем сигнала, считая желтые квадраты чужих окон, а чтобы не скучать — включаем старое доброе кино.\n\n---\n\n**22:40** Звездная карта найдена. Мы выбрались из лабиринта панелек, посмотрев отличную анимацию на дорожку. Спальный район остается позади, но его уют мы заберем с собой. День открыт, двигаемся дальше.",
  "todos": [
    {
      "id": 1,
  ...
  "streamLink": "https://www.twitch.tv/videos/2646914265",
  "hidden": false,
  "imageUrl": "https://i.ibb.co/cXFbZcvX/18.jpg", 
  "forceOpen": true,
  "customColor": "#f2f2f2"
  },
  19: {
  "title": "День 19",
  "description": "**15:00** Контент в транзите через черную дыру. Датчики цвета отказали — в этом секторе всё черно-белое. Ждем доставки, пока глаза привыкают к абсолютному контрасту.\n\n---\n\n**05:20** Транзит завершен. Мы вышли из зоны абсолютного контраста. Две цепочки следов разошлись в разные стороны, но привели героев домой. Этот черно-белый мир оказался на удивление теплым.",
  "todos": [
    {
      "id": 1,
      "text": "Жестко чиллить 😎🤙",
  ...
  "streamLink": "https://www.twitch.tv/videos/2647726451",
  "clipLink": "https://www.twitch.tv/gamelxrd/clip/VibrantMotionlessStarlingWutFace-WKLqkZqRasKd_bKG",
  "hidden": false,
  "imageUrl": "https://i.ibb.co/kVhQVTjC/19.jpg", 
  "forceOpen": true,
  "customColor": "#f2f2f2"
  },
  20: {
  ...
  "streamLink": "https://www.twitch.tv/videos/2649589047",
  "hidden": false,
  "imageUrl": "https://i.ibb.co/qY3XCbZj/blank.jpg",
  "forceOpen": true,
  "customColor": "#f2f2f2"
  ...
  22: {
  "title": "День 22",
  "description": "**17:30** Космический почтальон уже прибыл. Странно, но он игнорирует гравитацию и ползает по потолку кают-компании. Ждем, когда он к нам спустится.\n\n---\n\n**05:20** Внимание! Зафиксирован критический скачок биоэлектричества. Оно перегрузило систему нашего корабля, и трансляция просто сгорела. Мы вынуждены экстренно разорвать связь, пока не расплавился основной процессор.",
  "todos": [
    {
      "id": 1,
  ...
  "streamLink": "https://www.twitch.tv/videos/2650324779",
  "clipLink": "https://www.twitch.tv/gamelxrd/clip/GorgeousPunchyHerringOSsloth-mBAXgU9Wv0D3_h5G",
  "hidden": false,
  "imageUrl": "https://i.ibb.co/d0j0zXk0/22.jpg", 
  "forceOpen": true,
  "customColor": "#f2f2f2"
  },
  23: {
  "title": "День 23",
  "description": "**19:00** Запись на калибровке. На экранах появились странные символы, смысла которых мы не понимаем. Кто-нибудь может описать это словами, чтобы мы смогли продолжить движение?\n\n---\n\n**02:20** Символы сложились в маршрут спасения. Мы запустили сигнальную ракету в пустоту, и помощь пришла. Связь больше не прерывается. Добро пожаловать на борт — мы были здесь вместе, и мы справились!",
  "todos": [
    {
      "id": 1,
  ...
  "streamLink": "https://www.twitch.tv/videos/2651213815",
  "clipLink": "https://www.twitch.tv/gamelxrd/clip/CrazyMoistWoodpeckerBabyRage-Syt9xoPJH5-Gzqm-",
  "hidden": false,
  "imageUrl": "https://i.ibb.co/p6FXKVk6/21.jpg", 
  "forceOpen": true,
  "customColor": "#f2f2f2"
  },
  24: {
  "title": "В ночь перед Рождеством..",
  "description": "**19:30** Контент на финальной орбите. Болтаем в эфире, пока не приземлится.\n\n---\n\n**03:40** Мягкая посадка подтверждена. Двигатели заглушены. Мы завершили это большое путешествие. Спасибо, что были моим экипажем, помогали в штормах и делили радость открытий. С Рождеством вас! И пусть ваша жизнь будет полна Потрясающих Приключений. Конец связи, ваш Капитан!",
  "todos": [
    {
      "id": 1,
  ...
  "streamLink": "https://www.twitch.tv/videos/2652035307",
  "customColor": "amber",
  "hidden": false,
  "imageUrl": "https://i.ibb.co/Q77pMPCR/24.jpg", 
  "forceOpen": true
  }
};
