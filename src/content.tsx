...
export const defaultDaysData: Record<number, DayContent> = {
  1: {
  "description": "Сегодняшний день в космосе особенный. Звезды выстроились в уникальный узор, но погода портится. Не забудьте сделать паузу и посмотреть на небо — главное, чтобы вой ветра не сменился воем стаи. Пусть этот день принесет вам новые открытия.",
  "todos": [
    {
      "id": 1,
  ...
  2: {
  "description": "Запись второго дня уже расшифрована. Мы усердно работали над этим, чтобы недовольство не росло. Однако, Капитан не справился с управлением и надежда умерла вместе с чатом...",
  "todos": [
    {
      "id": 1,
  ...
  4: {
  "title": "День 4",
  "description": "Расшифровка не удалась — логи остались под толщей льда. Но стоять на месте нельзя, иначе замерзнем. Оставляем эту загадку снегам и двигаемся дальше.",
  "todos": [
    {
      "id": 1,
  ...
  5: {
  "title": "День 5",
  "description": "Файл с длинными логами задерживается — похоже, застрял где-то на полпути. Придется цепляться за ближайшую звезду и вытягивать его вручную. Ожидайте обновлений в чате.",
  "todos": [
    {
      "id": 1,
  ...
  "clipLink": "",
  "hidden": true,
  "imageUrl": "https://i.ibb.co/RGhMp9PN/5blur.jpg",
  "forceOpen": false,
  "customColor": "#f2f2f2"
  },
  6: {
  ...
  7: {
  "title": "День 7",
  "description": "Сервер стабилизируется. Надеюсь, ваши споры утихли. Сенсоры показывают, что ауры в зале окрасились в цвета нетерпения. Пожалуйста, дышите глубже и соблюдайте тишину — мы не хотим привлечь внимание Инквизиции к нашему собранию.",
  "todos": [],
  "streamLink": "",
  "clipLink": "",
  "hidden": true,
  ...
  8: {
  "title": "День 8",
  "description": "Данные этого дня в дешифровке. Температура падает, так что держитесь ближе к костру... то есть, к реактору. Отдыхайте с экипажем и присматривайте за остальными зрителями.",
  "todos": [],
  "streamLink": "",
  "clipLink": "",
  "hidden": true,
  ...
  "clipLink": "",
  "hidden": true,
  "imageUrl": "https://i.ibb.co/BKC00r9M/11blur.jpg",
  "forceOpen": false,
  "customColor": "#f2f2f2"
  },
  12: {
